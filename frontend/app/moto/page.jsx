...
export default function Home() {
  ...
  <aside className="navbar-left bg-light border-end shadow-sm">
        <NavBar />
      </aside>

      {/* Main Content */}
      <main className="main flex-grow-1 d-flex flex-column align-items-center justify-content-center">
          ...
          <div className="d-flex flex-column gap-1 bg-light px-5 py-4 px-sm-5">
            ...
            <div className="row">
              <div className="col-md-6">
                ...
                <Select
                  id="piloto"
                  value={opcionesPiloto.find(
                    (opcion) => opcion.value === pilotoId
                  )}
              ...
              <div className="col-md-6">
                ...
                <Select
                  id="marca"
                  value={opcionesMarca.find(
                    (opcion) => opcion.value === marcaMotoId
                  )}
            ...
            <div className="row mt-3">
              <div className="col-md-6">
                ...
                <Select
                  id="modelo"
                  value={opcionesModelo.find(
                    (opcion) => opcion.value === modeloId
                  )}
                      ...
                      <tr key={index}>
                        ...
                        <td style={{ width: "200px" }}>
                          <button
                            ...
                            onClick={() => searchMoto(dato.id)}
                          >
                            Actualizar
                          </button>
                          <button
                            className="btn btn-danger btn-sm"
                            onClick={() => inactivarMoto(dato.id)}
                          >
                            Inactivar
                          </button>
                        </td>
